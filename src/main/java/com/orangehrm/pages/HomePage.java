...
public class HomePage {
    ...
    private By adminTab = By.xpath("//span[text()='Admin']");//By.className("oxd-main-menu-item"); //By.xpath("//span[text()='Admin']");
    private By userIDButton = By.className("oxd-userdropdown-name");//oxd-userdropdown-tab
    private By logoutButton = By.xpath("//a[text()='Logout']");
    private By oranageHRMlogo =  By.className("oxd-brand-banner");//By.xpath("oxd-brand-banner");// //div[@class='oxd-brand-banner']//img
